...
Manages atomic conventional git commits, branch synchronization, and safe upstream pushing.

## When to reach for it

Type `/eng-git-commit`, or the agent reaches for it automatically when a task fits: staging and committing code.
...
Used during or at the end of implementation cycles.
