...
Executes first-principles adversarial code audits and architecture health checks on mission-critical components.

## When to reach for it

Type /eng-adversarial-audit, or the agent reaches for it during security or concurrency audits.
...
An in-depth alternative or complement to standard eng-code-review.
