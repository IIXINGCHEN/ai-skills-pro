...
Configures port-scan detection, rate-limiting firewall rules, and automated IP ban defense.

## When to reach for it

Type /eng-linux-security, or the agent reaches for it when securing Linux servers.
...
DevOps and server security hardening.
