...
Analyzes codebase architecture topology, design patterns, circular dependencies, and coupling metrics.
...
Complements eng-prime-context for deep structural analysis.
