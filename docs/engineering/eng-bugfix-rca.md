...
Investigates software defects, isolates reproduction triggers, and produces a structured Root Cause Analysis document.

## When to reach for it

Type /eng-bugfix-rca, or the agent reaches for it when troubleshooting bugs or test failures.
