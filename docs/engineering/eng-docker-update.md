...
Automates zero-downtime Docker Compose image updates, digest comparisons, and health checks.

## When to reach for it

Type /eng-docker-update, or the agent reaches for it when maintaining container stacks.
...
DevOps workflow for deployment and maintenance.
