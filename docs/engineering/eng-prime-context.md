...
Rapidly builds a mental model of an unfamiliar repository by analyzing structure, configs, and conventions.

## When to reach for it

Type `/eng-prime-context`, or the agent reaches for it automatically when a task fits: onboarding to a new codebase.
...
Runs at the start of work on a new repository.
