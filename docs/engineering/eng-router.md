...
Central lifecycle router and decision dispatch mapping all skills in ai-skills-pro.

## When to reach for it

Type /eng-router, or the agent reaches for it automatically when determining multi-stage development workflows.
...
The top-level orchestrator and entry point for all workflows in ai-skills-pro.
