...
Discovers breakout AI search keywords and evaluates micro-SaaS and SEO site opportunities.

## When to reach for it

Type /prod-mine-keywords, or the agent reaches for it when conducting market trend research.
...
Pre-product ideation and market sizing.
