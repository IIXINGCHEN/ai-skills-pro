...
Archives current session execution logs, tool calls, and created artifacts into structured markdown.

## When to reach for it

You invoke this by typing /prod-export-session, and the agent will not reach for it on its own.
...
Post-session audit and logging.
