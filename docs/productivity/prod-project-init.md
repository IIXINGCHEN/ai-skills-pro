...
Inspects tech stacks and generates local setup, dependency installation, and run instructions.

## When to reach for it

Type /prod-project-init, or the agent reaches for it when setting up developer environments.
...
Onboarding step before development.
