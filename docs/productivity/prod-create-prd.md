...
Transforms high-level concepts and user conversations into a formal Product Requirements Document.

## When to reach for it

Type `/prod-create-prd`, or the agent reaches for it automatically when a task fits: planning new products or features.
...
Initial requirements stage, feeds into eng-spec.
