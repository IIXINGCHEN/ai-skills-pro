...
Transforms human photos into Japanese anime cel-shaded illustrations with aesthetic backgrounds.

## When to reach for it

Type /vis-anime-stylize, or the agent reaches for it when stylizing anime portraits.
...
Specialized visual asset creation.
