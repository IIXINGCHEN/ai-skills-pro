...
Compiles high-end 3D character generation prompts from portrait photos using VTP-3D-01.

## When to reach for it

Type /vis-vtp-3d, or the agent reaches for it when creating 3D animated avatars.
