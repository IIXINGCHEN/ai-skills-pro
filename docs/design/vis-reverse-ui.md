...
Extracts computed styles, layout structures, and atomic CSS tokens from rendered web interfaces.

## When to reach for it

Type `/vis-reverse-ui`, or the agent reaches for it automatically when a task fits: replicating frontend components.
