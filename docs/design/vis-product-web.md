...
HTML5, CSS3, Vanilla JavaScript, and SVG by default, directly runnable with no build step. Frameworks or chart and icon libraries join only when the project genuinely benefits.

**Does it interrogate me about every design choice?**
...
- Business content lives in the data layer while structure, tokens, and components stay generic and reusable.
- The page reads with a clear hierarchy and one premium, coherent visual system.
- Desktop, tablet, and mobile recompose properly; accessibility basics and reduced-motion behavior hold.
- The self-review gate passed with zero console errors.

## Where it fits

Standalone creation lane inside the design bucket: it composes a full web experience directly from requirements, complementing the reverse-engineering lane of `vis-reverse-ui`.
